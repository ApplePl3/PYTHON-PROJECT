...
#Lớp CoinDebris dùng để mô tả đồng xu khi đập vào hộp.
class CoinDebris(object):
  
  #Hàm khỏi tạo đồng xu với các thuộc tính.
...
#Cập nhật trạng thái của đồng xu
...
#Vẽ đồng xu lên màn hình trò chơi.
