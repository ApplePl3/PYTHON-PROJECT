...
#Class Mushroom mô tả nấm trong game
...
#kiểm tra xem nấm có va chạm với nhân vật người chơi không. Nếu có va chạm, nó kích hoạt một hành động cụ thể (ví dụ: tăng sức mạnh) cho người chơi và loại bỏ nấm khỏi trò chơi.
...
#xử lý việc nấm bị hủy hoại hoặc loại bỏ khỏi trò chơi. Trong trường hợp này, nó đơn giản là loại bỏ đối tượng nấm khỏi danh sách của trò chơi.
